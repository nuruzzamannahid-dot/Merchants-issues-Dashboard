...
# Your Telegram Bot Token (loaded dynamically from environment)
...
def run_scheduled_mode():
    ...
    print("="*60)
    token_display = BOT_TOKEN[:20] if BOT_TOKEN else "None"
...
if __name__ == "__main__":
    ...
    if not BOT_TOKEN:
        ...
        print("[INFO] Please set the TELEGRAM_BOT_TOKEN environment variable and try again.", file=sys.stderr)
        sys.exit(1)
