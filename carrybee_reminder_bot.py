...
# Your Telegram Bot Token is loaded from environment variables for security
...
if __name__ == "__main__":
    ...
    # Validation check for TELEGRAM_BOT_TOKEN at startup
    if not BOT_TOKEN:
        print("[ERROR] TELEGRAM_BOT_TOKEN environment variable is not set. Please set it and try again.")
        sys.exit(1)
