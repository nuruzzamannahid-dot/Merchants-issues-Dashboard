...
# Your Telegram Bot Token is loaded from the environment variable TELEGRAM_BOT_TOKEN
...
if __name__ == "__main__":
    ...
    if not BOT_TOKEN:
        print("[ERROR] TELEGRAM_BOT_TOKEN environment variable is not set. Please set it and run again.", file=sys.stderr)
        sys.exit(1)
