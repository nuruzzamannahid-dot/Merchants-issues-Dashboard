...
# Your Telegram Bot Token loaded securely from environment variable
...
if __name__ == "__main__":
    ...
    # Startup environment variable validation inside __main__ block
    # so test runners importing the file won't crash on startup.
    if not os.environ.get("TELEGRAM_BOT_TOKEN"):
        print("[ERROR] TELEGRAM_BOT_TOKEN environment variable is not set!")
        print("Please set it prior to running the bot (e.g. export TELEGRAM_BOT_TOKEN=your_token_here)")
        sys.exit(1)
